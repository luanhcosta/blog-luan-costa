...
The difference is dramatic. The naive kernel is bottlenecked on memory bandwidth; the tiled kernel moves much more of the computation into the fast shared memory regime.
